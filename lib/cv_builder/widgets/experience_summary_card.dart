...
/// A completed [WorkExperience] shown as a clean summary card on
/// Step 3, with a preview of its description and Edit/Delete
/// actions.
///
          ...
          child: Column(
            ...
            children: [
              Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  InitialsBadge(text: experience.employer, size: width * 0.13),
                      ...
                      children: [
                        ...
                        Text(
                          experience.location.trim().isEmpty
                              ? '${experience.employer} · $dateRange'
                              : '${experience.employer} · '
                                    '${experience.location} · $dateRange',
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
